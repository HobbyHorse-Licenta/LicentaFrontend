...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    if (email !== undefined && password !== undefined) {
      if (
        validation.validateEmailAndPassword(email, password, false) === true
      ) {
        setLoading(true);
        authenticationUtils.login(email, password, () => setLoading(false));
      }
    } else {
      uiUtils.showPopUp("Warning", "Not all credentials provided");
    }
  };
      ...
      >
        <View style={{ alignItems: "center" }}>
          <Animatable.Image
            ...
            iterationDelay={4000}
            style={[styles.logoView, { resizeMode: "contain" }]}
            ...
            <View style={styles.buttonAndText}>
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  <Text style={styles.actionText} variant="labelSmall">
                  ...
                  >
                    <Text
                      style={[
                        { fontWeight: "bold", color: theme.colors.tertiary },
                      ]}
                      variant="labelSmall"
                    >
                      {" "}
