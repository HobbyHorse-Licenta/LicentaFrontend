...
import {
  ...
  setMinimumAge,
} from "../../redux/createScheduleState";
...
const SelectCompanion = ({
  ...
  const [numberOfPeopleSelectorOnTop, setNumberOfPeopleSelectorOnTop] =
    useState(true);
  ...
  const selectedMixed = () => {
    if (selectedGender === Gender.Mixed) {
      ...
      setSelectedGender(Gender.Mixed);
    }
  };
    ...
    <PrimaryContainer styleInput={{ padding: scale(10) }}>
      <View
        style={{
          ...
          zIndex: numberOfPeopleSelectorOnTop === true ? 3 : 0,
        }}
      >
        ...
        >
          <SelectNumberOfPeople
            ...
            onOpenOrClose={() =>
              setNumberOfPeopleSelectorOnTop(value => !value)
            }
