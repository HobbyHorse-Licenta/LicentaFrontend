  ...
  const getRightItem = () => {
    if (rightButtonText !== undefined && onRightButtonPress !== undefined) {
      return (
        <Button
          disabled={
            rightButtonEnable !== undefined ? !rightButtonEnable : false
          }
          text={rightButtonText}
          onPress={() => onRightButtonPress()}
          style={styles.rightItemPosition}
        />
      );
    }
    if (onChat !== undefined) {
    ...
    if (menuItems !== undefined) {
      return (
        <PopupMenu buttonStyle={styles.rightItemPosition} items={menuItems} />
      );
    }
  };
    ...
    <View style={{ position: "relative", backgroundColor: "green" }}>
      <AppHeader>
        {onBack !== undefined && (
          <Appbar.BackAction
            onPress={() => onBack()}
            style={SpacingStyles.goBackPosition}
          />
        )}
