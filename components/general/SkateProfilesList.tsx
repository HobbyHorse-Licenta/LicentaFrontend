...
const SkateProfilesList = ({
  suggestedSkateProfiles,
  attendingSkateProfiles,
}: Input) => {
  ...
  return (
    <ScrollView horizontal={true}>
      {attendingSkateProfiles !== undefined &&
        ...
        attendingSkateProfiles.map(skateProfile => {
          return (
            <SkateProfilePresenceCard
      ...
      {suggestedSkateProfiles !== undefined &&
        ...
        suggestedSkateProfiles.map(skateProfile => {
          return (
            <SkateProfilePresenceCard
              key={uuid.v4().toString()}
              cardOpacity={0.4}
