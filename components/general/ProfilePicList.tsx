...
const ProfilePicList = ({
  ...
  if (imageUrlsArray !== undefined) {
    if (imageUrlsArray.length > maxNormalPics) {
      ...
      secondaryStartingIndex = imageUrlsArray.length;
    }
  }
  ...
  if (grayedOutImageUrlsArray !== undefined) {
    if (grayedOutImageUrlsArray.length > maxGrayedOutPics) {
      ...
      totalPicCount = secondaryStartingIndex + grayedOutImageUrlsArray.length;
    }
  } else {
    totalPicCount = secondaryStartingIndex;
  }
  ...
  return (
    <View
      style={[
        ...
        { alignSelf: "center", width: componentWidth, height: imageSize * 2 },
      ]}
    >
      <View
        style={[
      ...
      >
        {grayedOutImageUrlsArray !== undefined &&
          grayedOutImageUrlsArray.map((imageUrl, index) => {
            if (index < maxNormalPics) {
              return (
                <Image
                  ...
                  style={[
                    {
                      right: computeImageOffset(index),
                      top: 0,
                      width: imageSize,
                      height: imageSize,
                    },
            ...
            if (index < maxGrayedOutPics) {
              return (
                <Image
                  ...
                  style={[
                    {
                      right: computeImageOffset(secondaryStartingIndex + index),
                      top: 0,
                      width: imageSize,
                      height: imageSize,
                    },
