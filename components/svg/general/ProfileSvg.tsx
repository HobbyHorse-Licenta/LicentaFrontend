...
export default function ProfileSvg(){
    ...
    const profile = `<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
    ...
    const ProfileSVG = () => <SvgXml xml={profile} width='100%' height='100%'/>
    return (
