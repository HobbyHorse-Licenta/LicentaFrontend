...
import { GeneralModal, HorizontalTextScroll, PrimaryContainer, SvgView } from '../general';
...
const SkateProfiles = ({profiles, value, onValueChange, addEnabled, holdFeatureEnabled, style} : Input) => {
    ...
    const { canStart, start, TourGuideZone } = useTourGuideController('heldskateProfile');
