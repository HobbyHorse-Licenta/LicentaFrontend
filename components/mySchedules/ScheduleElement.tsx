...
const ScheduleElement = ({
  ...
  return (
    ...
    >
      ...
      <Text>
        {format(schedule.startTime, "HH")}:{format(schedule.startTime, "mm")}-
        {format(schedule.endTime, "HH")}:{format(schedule.endTime, "mm")}
      </Text>

      <Text>
        Age: {schedule.minimumAge}-{schedule.maximumAge}
      </Text>
