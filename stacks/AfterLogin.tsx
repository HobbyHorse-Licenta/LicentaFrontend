...
} from "../screens/postLogin/profileConfig";
...
const AfterLogin = () => {
  ...
  const { user, addingSkateProfile } = useSelector(
  ...
  const initialStackName =
    currentRoute !== undefined ? currentRoute + "Stack" : "EventsStack";
    ...
    <SafeAreaView style={[{ width: "100%", height: windowHeight }]}>
      {user === undefined || addingSkateProfile === true ? (
        ...
        >
          ...
          <Stack.Screen
            name="PreSelectStyleAndExperience"
            component={PreSelectStyleAndExperience}
          />
          <Stack.Screen
            name="SelectStyleAndExperience"
            component={SelectStyleAndExperience}
          />
        ...
        <Tab.Navigator
          initialRouteName={
            firstProfileConfig === true ? "EventsStack" : initialStackName
          }
          screenOptions={{
            ...
            tabBarStyle: tabBarVisible
              ? { display: "flex" }
              : { display: "none", position: "absolute", bottom: -200 },
          }}
        >
          <Tab.Screen
