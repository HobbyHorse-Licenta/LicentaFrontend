...
export const loadWalkthorughStateAsync = createAsyncThunk(
  "walkthrough/loadWalkthorughStateAsync",
  async () => {
...
export const walkthroughStateSlice = createSlice({
  ...
  reducers: {
    ...
    resetWalkthroughState: () => initialState,
  },
...
export const {
  setScheduleWalkthrough,
  setEventsWalkthrough,
  setMyProfileWalkthrough,
  resetWalkthroughState,
} = walkthroughStateSlice.actions;
